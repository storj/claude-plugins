...
You should use `./scripts/submit-review.sh` script to post reviews. This script lives in the storj/storj checkout, so this skill assumes the user is operating from that working directory.
